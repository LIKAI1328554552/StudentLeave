...
<script type="text/javascript" language="JavaScript">
	...
	function formatterAction(val,row) {
		return "<a href='javaScript:openProcessActinstListModel("+JSON.stringify(row.id)+")'>流程执行过程</a>&nbsp;<a href='javaScript:openCommentListModel("+JSON.stringify(row.id)+")'>历史批注</a>&nbsp;<a target='_black' href='${pageContext.request.contextPath}/processDefinition/showViewByTaskId?taskId="+row.id+"'>查看流程图</a>"
	}
...
<body style="margin: 1px">
	<table id="dg" class="easyui-datagrid" style="padding: 10px;" width="100%" height="100%" data-options="
		...
		fitColumns:true,
		method:'GET',
		url:'${pageContext.request.contextPath}/task/finishedlist',
		toolbar:'#tb'
	">
		<thead>
			<tr>
